...
public class TroopsComponents extends HttpServlet {
     ...
     */
    public static final String VUE              = "/WEB-INF/troops-components.jsp";
    protected String URI_FR = "/fr/modules-de-troupe";
    protected String URI_DE = "/de/truppe-komponenten";
    protected String URI_EN = "/en/troop-components";

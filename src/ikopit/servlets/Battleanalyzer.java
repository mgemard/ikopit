...
public class Battleanalyzer extends HttpServlet {
     ...
     */
    public static final String VUE              = "/WEB-INF/battle-analyzer.jsp";

    static {
        ObjectifyService.register(UserSession.class);
    }

    protected String URI_FR = "/fr/analyser-de-combat-spacial";
    protected String URI_DE = "/de/raumkampf-auswerter";
    protected String URI_EN = "/en/space-battle-analyzer";

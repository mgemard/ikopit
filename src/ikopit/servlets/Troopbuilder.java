...
public class Troopbuilder extends HttpServlet {
     ...
     */
    public static final String VUE              = "/WEB-INF/troop-builder.jsp";

    protected String URI_FR = "/fr/entraineur-de-troupes";
    protected String URI_DE = "/de/truppen-simulator";
    protected String URI_EN = "/en/troop-trainer";

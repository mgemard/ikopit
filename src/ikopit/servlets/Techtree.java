...
public class Techtree extends HttpServlet {
     ...
     */
    public static final String VUE              = "/WEB-INF/techtree.jsp";
    
    protected String URI_FR = "/fr/arbre-technologique";
    protected String URI_DE = "/de/technologiebaum";
    protected String URI_EN = "/en/technology-tree";

...
public class Buildings extends HttpServlet {
     ...
     */
    public static final String VUE              = "/WEB-INF/buildings.jsp";

    protected String URI_FR = "/fr/batiments";
    protected String URI_DE = "/de/bauwerke";
    protected String URI_EN = "/en/buildings";

...
public class Components extends HttpServlet {
     ...
     */
    public static final String VUE              = "/WEB-INF/components.jsp";

    protected String URI_FR = "/fr/modules-de-vaisseau";
    protected String URI_DE = "/de/schiff-komponenten";
    protected String URI_EN = "/en/ship-components";

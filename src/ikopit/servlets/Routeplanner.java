...
public class Routeplanner extends HttpServlet {
     ...
     */
    public static final String VUE              = "/WEB-INF/route-planner.jsp";

    static {
        ObjectifyService.register(UserSession.class);
    }

    protected String URI_FR = "/fr/plannificateur-de-trajet";
    protected String URI_DE = "/de/routenplaner";
    protected String URI_EN = "/en/route-planner";

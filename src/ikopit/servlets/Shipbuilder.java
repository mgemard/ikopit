...
public class Shipbuilder extends HttpServlet {
     ...
     */
    public static final String VUE              = "/WEB-INF/ship-builder.jsp";

    protected String URI_FR = "/fr/constructeur-de-vaisseaux";
    protected String URI_DE = "/de/schiffsbauer";
    protected String URI_EN = "/en/ship-builder";

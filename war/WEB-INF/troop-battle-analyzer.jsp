...
<fmt:setBundle basename="troop_battle_analyzer" var="battle_analyzer" />
...
<br>
   ...
   <script src="https://fb.me/react-0.13.3.js"></script>
     <%--   <script src="https://fb.me/JSXTransformer-0.13.3.js"></script>  --%>
      ...
      <%-- compile with react-tools
			...
			<script src="inc/battle_analyzer/troop_string_parser_global_infinity.js"></script>
 ...
 $("#navbar-tropo-battle-analyzer").css({color:'#FFFFFF'});
